...
public class Draw2DColliderOutline : MonoBehaviour
{
    public Material lineMaterial;
    private GameObject countrylineObj;
    private GameObject regionlineObj;

    private List<GameObject> countrylineObjs;
    private List<GameObject> regionlineObjs;
    ...
    private void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                Region clickedRegion = hit.collider.GetComponent<Region>();
                if (clickedRegion != null)
                {
                    DrawCountyOutline(clickedRegion);
                }
            }
        }

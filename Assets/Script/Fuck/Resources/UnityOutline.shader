...
// 替代循环，手动展开 8 次采样
{
    ...
    offset = kOffsets[0] * _MainTex_TexelSize.xy;
    id = tex2D(_MainTex, i.uv + offset).r;
    if (id != 0 && id - currentTexel.r != 0) currentTexel.a = 0;

    offset = kOffsets[1] * _MainTex_TexelSize.xy;
    id = tex2D(_MainTex, i.uv + offset).r;
    if (id != 0 && id - currentTexel.r != 0) currentTexel.a = 0;

    offset = kOffsets[2] * _MainTex_TexelSize.xy;
    id = tex2D(_MainTex, i.uv + offset).r;
    if (id != 0 && id - currentTexel.r != 0) currentTexel.a = 0;

    offset = kOffsets[3] * _MainTex_TexelSize.xy;
    id = tex2D(_MainTex, i.uv + offset).r;
    if (id != 0 && id - currentTexel.r != 0) currentTexel.a = 0;

    offset = kOffsets[4] * _MainTex_TexelSize.xy;
    id = tex2D(_MainTex, i.uv + offset).r;
    if (id != 0 && id - currentTexel.r != 0) currentTexel.a = 0;

    offset = kOffsets[5] * _MainTex_TexelSize.xy;
    id = tex2D(_MainTex, i.uv + offset).r;
    if (id != 0 && id - currentTexel.r != 0) currentTexel.a = 0;

    offset = kOffsets[6] * _MainTex_TexelSize.xy;
    id = tex2D(_MainTex, i.uv + offset).r;
    if (id != 0 && id - currentTexel.r != 0) currentTexel.a = 0;

    offset = kOffsets[7] * _MainTex_TexelSize.xy;
    id = tex2D(_MainTex, i.uv + offset).r;
    if (id != 0 && id - currentTexel.r != 0) currentTexel.a = 0;
}
